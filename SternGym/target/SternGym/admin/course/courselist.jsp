...
<div class="demoTable">
 ...
 <a href="/admin/goaddorupdate.html" class="layui-btn"><i class="layui-icon">&#xe608;</i> 添加</a>

<table class="layui-table" id="test" lay-data="{height: 'full-25'}" lay-filter="demo"></table>
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">查看</a>
    <a class="layui-btn layui-btn-xs" lay-event="edit" href="/admin/goaddorupdate.html?cid={{d.cid}}">编辑</a>
...
//                layer.msg('ID：'+ data.cid + ' 的查看操作');
                layer.open({
                    ...
                    title:'查看课程信息',
                    area:['800px','300px'],
                    content:'/admin/courseinfo.html?cid='+data.cid,
                });
            } else if(obj.event === 'del'){
                layer.confirm('真的删除该课程么', function(index){
                    $.ajax({
                        url:"/admin/course/del.html",
                        type:"post",
                        data:"cid="+data.cid,
