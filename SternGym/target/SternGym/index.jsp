            ...
            <%--<div class="header-main">--%>
                ...
                <%--<div class="header-right">--%>
                    <%--<div class="top-nav">--%>
                        ...
                        <%--<ul class="res">--%>
                            <%--<li><a class="active  scroll" href="/index.html">首页</a></li>--%>
                            <%--<li><a class="scroll" href="/about.html">关于我们</a></li>--%>
                            <%--<li><a class="scroll" href="/news.html">新闻活动</a></li>--%>
                            <%--<li><a class="scroll" href="/course.html">健身课程</a></li>--%>
                            <%--<li><a class="scroll" href="/login.html">会员登录</a></li>--%>
                        <%--</ul>--%>
                        <%--<!-- menu 窗口缩小点击展示 -->--%>
                        <%--<script>--%>
                        ...
                        <li>
                            <c:forEach items="${newskinds}" var="kind">
                                <c:if test="${kind.nkid == huodong.nkId}">
                                    <a href="/newsinfo.html?nid=${huodong.nid}">[${kind.nkname}]${huodong.ntitle}</a>
                                </c:if>
                            </c:forEach>
                        </li>
                    </c:forEach>
                        ...
                        <li>
                            <c:forEach items="${newskinds}" var="kind">
                                <c:if test="${kind.nkid == gonggao.nkId}">
                                    <a href="/newsinfo.html?nid=${gonggao.nid}">[${kind.nkname}]${gonggao.ntitle}</a>
                                </c:if>
                            </c:forEach>
                        </li>
                    </c:forEach>
