...
public class SendMail {
    public static boolean sendMail(String email,String name) {
        ...
        String from = "765349477@qq.com"; 				// 邮件发送人的邮件地址
        String to = email; 										// 邮件接收人的邮件地址
        final String username = "765349477@qq.com";  	//发件人的邮件帐户
        final String password = "wqhyhsvhhlzqbdai";   					//发件人的邮件密码
        String emailMsg = "成功，请"+name+"使用'123456789'";
