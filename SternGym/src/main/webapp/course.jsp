                ...
                <div class="tabbable" id="tabs-364153">
                    ...
                    <div class="tab-content">
                                        ...
                                        <li class="span4">
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <%--</p>--%>
                                                    <p>
                                                        <a class="btn btn-primary" href="/courseinfo.html?cid=${course.cid}">查看</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="tab-pane" id="panel-812368">
                            <p>
                                <a class="btn btn-primary" href="http://localhost:8080/sterngymimages/${sheetsrc}" target="_blank">点击查看课表</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        ...
        var options = {
            ...
            onPageClicked:function (event,originalEvent,type,page) {
                location.href = "/course.html?page="+page+"&cate="+$("#first")[0].innerText+"&func="+$("#second")[0].innerText;
            }
        };
