											...
											<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<img id="kaptcha" style="cursor: pointer;cursor: hand;margin-top: -35px;margin-left: 100px"
																 onclick="this.src='/login/captcha.html?'+Math.random();"
																 src="/login/captcha.html">
														</span>
											</label>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
	    $("#regBtn").click(function () {
			$.ajax({
				url:'/user/verifyemailandphone.html',
                        ...
                        $("#loginForm").ajaxSubmit({
                            ...
                            success:function (res) {
                                if(res.status == "1") {
                                    ...
                                    alert(res.msg);
                                    $("#verifycode")[0].value = "";
                                    $("#kaptcha").attr("src",'/login/captcha.html?'+Math.random());
                                }
                            }
                        });
					}else {
