...
<span class="layui-breadcrumb">
  ...
  <a href="/admin/courselist.html">课程管理</a>
    <c:choose>
...
<form class="layui-form" action="/admin/addorupdate.html" method="post">
        ...
        var uploadInst = upload.render({
            ...
            , done: function (res) {
                ...
                if (res.code > 0) {
                    ...
                    $('#cpic').val("http://localhost:8080/sterngymimages/"+res.data.src);
